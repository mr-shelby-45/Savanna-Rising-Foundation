...
const values = [
  {
    title: 'Earned Respect On & Off the Pitch.',
    body: 'On the field, respect is earned through character and effort—not status or background. We hold ourselves and our programmes to that same standard.',
  },
  {
